class JobOpportunity {
  ...
  static List<JobOpportunity> sampleJobs() => [
    ...
    JobOpportunity(id: 'j2', title: '웹 디자이너', company: '킹콩 디자인', location: '부산시 해운대구', type: '디자인', requirements: 'UI/UX, 그래픽 디자인 가능'),
    ...
    JobOpportunity(id: 'j3-2', title: 'AI 연구 보조', company: 'AI테크', location: '판교', type: '분석', requirements: 'ML/DL 지식 보유'),
