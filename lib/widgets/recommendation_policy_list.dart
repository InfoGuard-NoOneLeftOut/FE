...
// 메인 위젯
class RecommendationPolicySection extends StatefulWidget {
  final List<WelfarePolicy> policies;

  const RecommendationPolicySection({Key? key, required this.policies}) : super(key: key);

  @override
  State<RecommendationPolicySection> createState() => _RecommendationPolicySectionState();
}

class _RecommendationPolicySectionState extends State<RecommendationPolicySection> {
  bool _showAll = false;
